    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col justify-center">
        <div className="flex flex-col sm:flex-row justify-between items-center p-4 sm:p-8 lg:p-15">
          ...
          <div className="absolute top-0 right-0 animate-slideIn">
            <Image
              src={logoMode === "light" ? "/assets/sun.png" : "/assets/moon.png"}
              alt="Weather Mode"
              width={140}
              height={140}
              className="drop-shadow-lg"
          ...
          <div className="flex flex-row items-end">
            <div>
              <div className="flex flex-row mt-2 mb-0 py-0">
                {/* Weather Info */}
                <div className="flex items-center lg:px-4 py-2 max-w-sm mx-auto space-x-4 text-black">
                  <span className="h-[36px] w-[36px] flex items-center justify-center flex-shrink-0 border border-black/60 p-1.5">
                    <Image
                      src="/assets/weather.png"
                      alt="time logo"
                      height={24}
                ...
                {/* Opening Hours */}
                <div className="flex items-center lg:px-4 py-2 max-w-sm mx-auto space-x-4 text-black">
                  <span className="h-[36px] w-[36px] flex items-center justify-center flex-shrink-0 border border-black/50 p-1.5">
                    <Image
                      src="/assets/timeicon_dark.png"
                      alt="time logo"
                      height={24}
              ...
              <div className="flex flex-col items-end space-y-2">
                <div className="flex items-center space-x-3 text-black/90">
                  <div className="flex items-center space-x-2 text-sm font-semibold lg:px-33">
                    <button
                      ...
                      className={`pr-6 ${
                        locale === "en" ? "text-green-600" : "text-black"
                      }`}
                    >
                      Eng
                    </button>
                    ...
                    <button
                      ...
                      className={`pl-6 ${
                        locale === "ur" ? "text-green-600" : "text-black"
                      }`}
                    >
                      اردو
                    </button>
                ...
                <div className="flex space-x-3 mr-8">
                  <button
                    className="w-[114px] px-3 py-1.5 text-white text-sm font-medium bg-green-600 hover:bg-green-700 transition shadow-md border-1 border-white/80"
                    onClick={() => router.push("/bestexeng")}
                  >
                    {messages.bestEng}
                  </button>
                  <button className="w-[114px] px-3 py-1.5 text-white text-sm font-medium bg-green-600 hover:bg-green-700 transition shadow-md border-1 border-white/80">
                    {messages.alert}
                  </button>
                </div>
              </div>
